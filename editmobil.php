...
if(isset($_POST['update'])){
  ...
  $result = mysqli_query($conn , "UPDATE mobil SET Merk='$Merk', Warna='$Warna', NomorPolisi='$NomorPolisi', Harga=$Harga, Deskripsi='$Deskripsi' WHERE ID_Mobil='$ID_Mobil'");
    ...
    <div class="container-fluid"> 
        ...
        <form action="" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Merk" value="<?php echo $Merk;?>" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Warna" value="<?php echo $Warna;?>" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="NomorPolisi" value="<?php echo $NomorPolisi;?>" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Harga" value="<?php echo $Harga;?>" autocomplete="off">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Deskripsi" value="<?php echo $Deskripsi;?>" autocomplete="off">
                </div>
            </div>
